...
# import libraries
from framework.grdb.apiValidation.rules.PushRateRule import PushRateRule
...
def main(event, context):
	...
	return RateApiHandler.handle(event, "pushRateRequest", "pushRateResponse", RateApiType.PushRate, PushRateRule())
