...
# import libraries
from framework.grdb.apiValidation.rules.MarkupMarkdownRule import MarkupMarkdownRule
...
def main(event, context):
	...
	return RateApiHandler.handle(event, "markupMarkdownRequest", "markupMarkdownResponse", RateApiType.MarkupMarkdown, MarkupMarkdownRule())
