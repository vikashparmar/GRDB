...
# import libraries
from framework.grdb.apiValidation.rules.ExpireExtendRule import ExpireExtendRule
...
def main(event, context):
	...
	return RateApiHandler.handle(event, "expireExtendRequest", "expireExtendResponse", RateApiType.ExpireExtend, ExpireExtendRule())
